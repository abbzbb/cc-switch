...
### Fork リリース：**[abbzbb/cc-switch](https://github.com/abbzbb/cc-switch/releases)**

このリポジトリは [farion1231/cc-switch](https://github.com/farion1231/cc-switch) の fork です。上流プロジェクトのサイトは [ccswitch.io](https://ccswitch.io) です。
