...
- [Pick a model by provider](../4-proxy/4.6-model-routing.md) / [Combo](../4-proxy/4.7-combo.md) / [Sidecar](../4-proxy/4.8-sidecar.md) — pin a card after takeover, cross-card strategy, search and vision
